...
```
<br><span style="color:blue">
<b>There were incomplete data in the data sets as noted below.</b></span><br>
The field that was most commonly incomplete was IBU, which unlike ABVs are not required by law to be shared with a consumer.
<br>
...
We wanted to share the range of the alcohol content and bitterness </b><br></span><br>
You can see from the boxplat that there are outliers- which can affect the analysis, but they are valid data points.
...
```
<br><b><span style="color:blue">
Approximately 44% of the variance of IBUs can be explained by ABV.</b></span><br><br>
