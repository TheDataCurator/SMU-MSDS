...
<br>
<b>There were incomplete data in the data sets as noted below. The field that was most commonly incomplete was IBU.</b>
<br>
...
```
<br>
<b>For perspective, we looked at the median alchol content and bitterness unit for each state.</b>
<br>
...
```
<br><b>
We wanted to share the range of the alcohol content and bitterness </b><br>
```{r Summary Statistics, echo=FALSE}
#6. Summary Statistics for ABV
summary(ABV_state$ABV_Pct)
```

<br><b> We plotted bitterness and alcohol content to see if there was a relationship between the values, but the results were unremarkable."
</b><br>
...
```
<br><b>
The study showed a weak positive correlation (0.282) between ABV and IBUs using scatter plot and Pearson's Product correlation formula.</b><br>
...
```
<br>In summary, their was not evidence of a relationship between the ABV and IBU. The state of Maine had the highest IBU content and there was a tie for alcohol content between the the District of Columbia and the state of Kentucky.
