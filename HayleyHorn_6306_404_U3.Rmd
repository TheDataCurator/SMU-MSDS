...
df <- read.csv("~/awesome-public-datasets/Datasets/titanic/titanic.csv")
...
#c. Output means of age, fare and survival- use one *apply* funtion learned in swirl
sapply(df[c("Age","Fare","Survived")],SIMPLIFY = TRUE, mean, na.rm = TRUE)

```

###3.	Function Building

```{r a:d, buildingreport echo=TRUE}
...
df <- data(package = "fivethirtyeight")
df$results[22, "Item"]
...
dim(data(package = "fivethirtyeight"))
colnames(df)
```
